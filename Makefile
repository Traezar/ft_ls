...
#    Updated: 2018/10/07 18:17:52 by rsathiad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(addprefix libft/src/libft/, $(libftbasic)) \
				$(addprefix libft/src/ft_printf/, $(printf))
OBJ = *.o
HDR = $(addprefix libft/includes/, $(ft_printf.h)) \
			$(addprefix libft/includes/, $(libft.h))
